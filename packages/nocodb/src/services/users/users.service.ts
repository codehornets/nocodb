...
export class UsersService {
  ...
  async onboarding(param: {
    body: OnboardingReqType;
    req: any;
    res: any;
  }): Promise<any> {
    validatePayload(
      'swagger.json#/components/schemas/OnboardingReq',
      param.body,
    );

    const { email: _email, website, linkedin, goals } = param.req.body;

    console.log('param.req.body', param.req.body);
  ...
  async businessProfile(param: {
    body: BusinessProfileReqType;
    req: any;
    res: any;
  }): Promise<any> {
    validatePayload(
      'swagger.json#/components/schemas/BusinessProfileReq',
      param.body,
    );
    ...
    if (user) {
      console.log(
        'Generating business profile for user',
        user,
        website,
        linkedin,
        goals,
      ...
      console.log('Business profile generated for user', user);
    } else {
